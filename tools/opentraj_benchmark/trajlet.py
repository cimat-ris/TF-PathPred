...
if __name__ == "__main__":
    ...
    eth_dataset = loadETH(os.path.join(opentraj_root, "datasets/ETH/seq_eth/obsmat.txt"))
    ...
    paired_trajlets = split_trajectories_paired(trajs, to_numpy=True)
    print(trajlets_4_8s.shape, trajlets_8s.shape, paired_trajlets.shape)
